            ...
            <div class="content-box-large">
                ...
                <div class="panel-body" style="overflowauto;">
                    <div class="col-xs-4"></div><div class="col-xs-4">
                        ...
                        <br><button ttype="submit" value="click" name="submit" class="btn btn-primary center-block" >Add 10 Medical Kits</button></form></div>
                </div>
            </div>
...
// Check connection
        ...
        $query1 = "UPDATE inventory SET medical_kit= $row[1]+10  WHERE id=1 ";
