...
public class DonorRegister extends AppCompatActivity {
    private static final String TAG = "DonorRegister";
    String reg_url = "http://10.49.177.50/volley/login/register.php";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        builder = new AlertDialog.Builder(DonorRegister.this);
        ...
        _loginLink.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(getApplicationContext(),DonorLoginActivity.class);
    ...
    public void signup() {
        ...
        MySingleton.getInstance(DonorRegister.this).addToRequestque(stringRequest);
    }
        ...
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                if(code.equals("reg_success")){
                    User user = new User(DonorRegister.this);
