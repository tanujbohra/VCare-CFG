...
public class DonorLoginActivity extends AppCompatActivity {
    ...
    String login_url = "http://10.49.177.50/volley/login/login.php";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        builder = new AlertDialog.Builder(DonorLoginActivity.this);
        ...
        _signupLink.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(getApplicationContext(), DonorRegister.class);
    ...
    public void login() {
                    ...
                    public void onResponse(String response) {
                        try{
                            ...
                            if(code.equals("login_failed")){
                                ...
                                User user = new User(DonorLoginActivity.this);
        ...
        MySingleton.getInstance(DonorLoginActivity.this).addToRequestque(stringRequest);
    }
